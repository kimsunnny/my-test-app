<template>
  <div class="box studyland">
    ...
    <NuxtLink to="/studyland/onestep/first" class="btn-item onestep-link link-img on"><span class="sr-only">1단계</span></NuxtLink>
    <NuxtLink to="/studyland/twostep/first" class="btn-item twostep-link link-img"><span class="sr-only">2단계</span></NuxtLink>
    <NuxtLink to="/calendar" class="calendar-link link-img hover-bigger"><span class="sr-only">캘린더 페이지 이동</span></NuxtLink>
    <!-- 회차 탭 -->
    <ul class="tab-list">
      <li><NuxtLink to="/studyland/onestep/first" class="tab-01 on"><span class="sr-only">1회</span></NuxtLink></li>
      <li><NuxtLink to="/studyland/onestep/second" class="tab-02"><span class="sr-only">2회</span></NuxtLink></li>
      <li><NuxtLink to="/studyland/onestep/third" class="tab-03"><span class="sr-only">3회</span></NuxtLink></li>
      <li><NuxtLink to="/studyland/onestep/fourth" class="tab-04"><span class="sr-only">4회</span></NuxtLink></li>
      <li><NuxtLink to="/studyland/onestep/fifth" class="tab-05"><span class="sr-only">5회</span></NuxtLink></li>
    </ul>
    <!-- 카드 슬라이더 -->
    <div class="card-wrap">
    ...
    <NuxtLink :to="{name: 'contents-id', params:{id: 0, theme: 'studylandOneStep'}}" class="promise-link link-img hover-bigger"><span class="sr-only">오늘의 약속</span></NuxtLink>
